...
<html>
 ...
 <h1>A toolkit to extract jobs from <a href="https://www.monster.com/"> Monster.com </a>.  The idea here is to automatically extract the job links from monster using selenium webdriver. The scripts later look for the given keywords in the job description and only keeps those links which has greater than 50% of the supplied keywords.</h1>
