...
class plotter:
    ...
    def plot_(self, file_):
        ...
        fig_1.write_image('../images/'+'bar'+file_.split('.')[0]+'.svg',scale=2)
        fig_1.write_html('../images/'+'bar'+file_.split('.')[0]+'.html') 
        fig_1.show()
        ...
        fig_2.write_image('../images/'+'pie'+file_.split('.')[0]+'.svg',scale=2)
        fig_2.write_html('../images/'+'pie'+file_.split('.')[0]+'.html') 
